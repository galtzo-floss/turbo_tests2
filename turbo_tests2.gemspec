...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/turbo_tests/version.rb", mod) }::TurboTests::Version::VERSION
  else
    require_relative "lib/turbo_tests/version"
    TurboTests::Version::VERSION
  end

Gem::Specification.new do |spec|
  spec.name = "turbo_tests2"
  spec.version = gem_version
  spec.authors = ["Illia", "Ilya Zub", "AMHOL", "Serge Bedzhyk", "Bo Anderson", "Dmitiry Zub☀️", "mrudzki", "Sebastien Savater", "David Rodriguez", "Hiroshi SHIBATA", "Gareth Jones", "Peter H. Boling"]
  ...
  spec.description = "🚀 turbo_tests2` is a drop-in replacement for `serpapi/turbo_tests` and `grosser/parallel_tests` with incremental summarized output. Source code of `turbo_test2` gem is based on Discourse and Rubygems work in this area (see README.md)."
  ...
  spec.metadata["homepage_uri"] = "https://turbo-tests2.galtzo.com"
  ...
  spec.add_development_dependency("kettle-dev", "~> 2.2", ">= 2.2.8")      # ruby >= 2.4
  ...
  # The 'git' gem is optional; turbo_tests2 falls back to shelling out to `git` if it is not present.
